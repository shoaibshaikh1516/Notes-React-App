  ...
  return (
    <div>
      ...
      {/* <div className="flex " >
        ...
        <ProductDetails header="Premium" metadata="1$" description=" Take notes" noOfUser="Less then 5"></ProductDetails>
        <ProductDetails header="Enterprise" metadata="5$" description=" Over all access" noOfUser="More the 5 Users"></ProductDetails>
      </div> */}
